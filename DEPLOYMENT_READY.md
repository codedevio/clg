...
2. Under "CORS" settings, add your deployment domain:
   - **Custom Domain**: `https://quizorax.codedevio.in`
...
## 🌐 Custom Domain Setup (quizorax.codedevio.in)

Both Vercel and Render are configured to support the custom domain `quizorax.codedevio.in`:

### Quick Domain Configuration

**For Vercel:**
1. Go to Vercel Dashboard → Settings → Domains
2. Add `quizorax.codedevio.in`
3. Configure DNS at your registrar (follow Vercel's instructions)

**For Render:**
1. Go to Render Dashboard → Service Settings → Custom Domain
2. Add `quizorax.codedevio.in`
3. Configure CNAME record: `quizorax.codedevio.in` → `<service>.onrender.com`

See [DEPLOYMENT_DOMAIN_SETUP.md](./DEPLOYMENT_DOMAIN_SETUP.md) for detailed instructions.
